...
const builder = {
    wrong_cred: prefix => builder.prepare(403, prefix, 'Invalid credentials'),
    ...
    invalid_auth_code: prefix => builder.prepare(403, prefix, 'entered auth code is invalid'),
    ...
    already_verified: prefix => builder.prepare(419, prefix, 'already verified'),
